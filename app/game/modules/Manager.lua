local ____exports = {}
local ManagerModule
local ____modules_const = require("game.modules.modules_const")
local _ID_MESSAGES = ____modules_const._ID_MESSAGES
local ____game_config = require("game.main.game_config")
local ID_YANDEX_METRICA = ____game_config.ID_YANDEX_METRICA
local ____System = require("game.modules.System")
local register_system = ____System.register_system
local ____Log = require("game.modules.Log")
local register_log = ____Log.register_log
local ____EventBus = require("game.modules.EventBus")
local register_event_bus = ____EventBus.register_event_bus
local ____Storage = require("game.modules.Storage")
local register_storage = ____Storage.register_storage
local ____GameStorage = require("game.modules.GameStorage")
local register_game_storage = ____GameStorage.register_game_storage
local ____Sound = require("game.modules.Sound")
local register_sound = ____Sound.register_sound
local ____Lang = require("game.modules.Lang")
local register_lang = ____Lang.register_lang
local ____Scene = require("game.modules.Scene")
local register_scene = ____Scene.register_scene
local ____Ads = require("game.modules.Ads")
local register_ads = ____Ads.register_ads
local ____Rate = require("game.modules.Rate")
local register_rate = ____Rate.register_rate
local ____Metrica = require("game.modules.Metrica")
local register_metrica = ____Metrica.register_metrica
local ____Camera = require("game.modules.Camera")
local register_camera = ____Camera.register_camera
local ____HtmlBridge = require("game.modules.HtmlBridge")
