...
function HtmlBridgeModule()
    ...
    local function init_purchases(cb)
        js.call_js_with_callback("sdk.init_purchases", {}, cb)
    end
    local function get_purchases(cb)
        js.call_js_with_callback("sdk.get_purchases", {}, cb)
    end
    local function purchase(params, cb)
        js.call_js_with_callback("sdk.purchase", params, cb)
    end
    local function consume_purchase(token, cb)
        js.call_js_with_callback("sdk.consume_purchase", {token = token}, cb)
    end
    local function get_flags(params, cb)
